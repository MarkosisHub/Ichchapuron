...
const AdminProductListScreen = () => {
  ...
  const header = (
    <div className="table-header">
      <h5 className="mx-0 my-1">All Products</h5>
  ...
  return (
    <section className="adminProductListSection">
      <div className="adminProductListWrapper">
        <div className="adminProductListDetails">
          <div className="adminProdctListContentLeft">
            <AdminSidenav />
          </div>
          <div className="adminProductListContentRight">
            <AdminNavbar />
